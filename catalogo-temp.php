...
<div>
	<select>
	  <option value="volvo">SELECCIONE ARTICULO</option>
	  <option value="volvo">Playeras</option>
	  <option value="saab">Camisas</option>
	  <option value="mercedes">Trajes</option>
	  <option value="audi">Ropa Deportiva</option>
	 	<option value="volvo">Trajes de Baño</option>
	  <option value="saab">Accesorios</option>
	  <option value="mercedes">Pantalones</option>
	  <option value="audi">Sudaderas</option>
	</select>
</div>
